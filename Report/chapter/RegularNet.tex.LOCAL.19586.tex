...
\myFigure{Regular}{Convolutional Neural Network feature map striding example \citep{RegularNET_Strinding}}{fig:RegularStrinding}{0.5}
\FloatBarrier
...
\myFigure{Regular}{Convolutional Neural Network Architecture \citep{RegularNET_CVNN}}{fig:RegularCVNN}{0.5}
\FloatBarrier
