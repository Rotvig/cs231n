...
\myFigure{results/RegularNet/LabelWise/label8_500.PNG}{Label 8 - Ship (RegularNet)}{fig:ship}{0.8}
\FloatBarrier
...
\FloatBarrier
\subsubsection{Label 8 - Ship}
\myFigure{results/ResNet/LabelWise/label8_500.PNG}{Label 8 - Ship (ResNet)}{fig:shipRes}{0.8}
\FloatBarrier
\subsubsection{Label 9 - Truck}
...
\FloatBarrier
\subsubsection{Label 8 - Ship}
\myFigure{results/DenseNet/LabelWise/label8_500.PNG}{Label 8 - Ship (DenseNet)}{fig:shipDense}{0.8}
\FloatBarrier
\subsubsection{Label 9 - Truck}
