...
\myFigure{results/RegularNet/classiacc.PNG}{Test Accuracy (RegularNet)}{fig:testaccreg}{0.8}
\FloatBarrier
...
\myFigure{results/ResNet/classiacc.PNG}{Test Accuracy (ResNet)}{fig:testaccres}{0.8}
\FloatBarrier
...
\myFigure{results/DenseNet/classiacc.PNG}{Test Accuracy (DenseNet)}{fig:testaccdense}{0.8}
\FloatBarrier

\subsection{Scrambled Classification}

\myFigure{results/DenseNet/scrambled/scrambled2000.PNG}{2000 images with rotation from 0 - 360 degrees (DenseNet)}{fig:scram}{0.8}
\FloatBarrier
