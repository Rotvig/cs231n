...
\todo{Grundlæggende problem: Der er ingen af dine billeder som er indsat korrekt (se hvordan det er gjordt i andre afsnit såsom Theory/DenseNet. Udover det så refererer du ikke til alle dine billeder - hvis et billed ikke er referetet med en \ref{fig:billede} så skal det fjernes. Desuden har du lavet en \citep{} i alle dine figur tekster. Men du har ikke tilføjet noget til bibliografien. \citep bruges kun til at referer til artikler eller bøger fra bibliografien. Det er samme problem i din teori del og din implementation del)}
